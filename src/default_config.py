...
CILIA_CP_DOUBLET_LENGTH_DIFF = 300.0  # CP - doublet length difference (Angstroms)
...
TIP_FINAL_RADIUS = CILIA_CP_RADIUS + CILIA_CP_SHIFT + 120
TIP_TRANSITION_LENGTH = 1500
TIP_INITIAL_LENGTH = 300
TIP_LENGTH = 5000
TIP_CAP_RADIUS = CILIA_CP_RADIUS + CILIA_CP_SHIFT + 100
TIP_CAP_LENGTH = TIP_CAP_RADIUS*2.5
...
CILIA_CAP_COLOR = (180, 180, 30, 255)
